...
void countPoints(struct triangle *tri, void (*callback)(int boundary, int interior)) {
	...
	for(int x = xmin; x <= xmax; ++x) {
		for(int y = ymin; y <= ymax; ++y) {
			...
			if((fabs(l1) < eps && int01(l2) && int01(l3)) || //|l1| < 0.0000001 && l2,l3 in [0:1]
			   (fabs(l2) < eps && int01(l1) && int01(l3)) || //|l2| < 0.0000001 && l1,l3 in [0:1]
			   (fabs(l3) < eps && int01(l1) && int01(l2))) { //|l3| < 0.0000001 && l1,l2 in [0:1]
				boundary++;
				cur_boundary++;
